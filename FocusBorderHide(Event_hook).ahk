...
;in this implementation we will use event hook set on selection change. If the sel change is within a common control known to produce focus borders, they are immediately removed
...
FocusLineHide(Active=True,chwnd="") {
	static ptr:="ptr", uint:= "uint"
	, WM_UPDATEUISTATE := 0x0128
	, SET_HIDEFOCUS    := 0x00010001 , NULL:=0
	return,result:= DllCall("PostMessage",ptr,Active? CtrlGetActiveHwnd() : chwnd
									,uint,WM_UPDATEUISTATE,ptr,SET_HIDEFOCUS,ptr,NULL)
}
